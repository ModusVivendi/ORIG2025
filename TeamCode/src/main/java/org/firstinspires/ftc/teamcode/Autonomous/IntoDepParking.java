...
@Autonomous(name="Parking_IntoDeep", group="IntoDeep")
public class IntoDepParking extends LinearOpMode {
    ...
    private static final Pose2d Transit_1_POSITION = new Pose2d(10, -58, Math.toRadians(90));  // First sample position
    private static final Pose2d PARKING_ZONE = new Pose2d(55, -58, Math.toRadians(90)); // Human player zone position
